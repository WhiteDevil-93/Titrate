...
function pickGCSRow(el, score, catKey, tableId) {
  ...
  if (categoriesFilled < 3) {
    totalEl.innerHTML = `Total: <span style="color:var(--t);font-size:1.1rem">--</span> / 15 <span style="font-size:.7rem;color:var(--t2)">(${3 - categoriesFilled} categor${categoriesFilled < 2 ? 'y' : 'ies'} remaining)</span>`;
